...
```{r epe_plot, echo=FALSE, message=FALSE, fig.width=8, fig.height=0.4*nrow(sheet)}
...
### Duplication
This plot shows the proportion of fragments that are positional duplicates in
...
```{r dup_plot, echo=FALSE, message=FALSE, fig.width=8, fig.height=0.4*nrow(sheet)}
par(mar=c(4, 3.5, 1, 0), mgp=c(2.5, 0.75, 0))
...
This plot shows the proportion of fragments that map to exons, introns, and
between genes.

```{r gdna_plot, echo=FALSE, message=FALSE, fig.width=8, fig.height=0.8*nrow(sheet)}
par(mar=c(4, 3.5, 1, 0), mgp=c(2.5, 0.75, 0))
gdna_dat <- matrix(
    c(
...
at <- barplot(
    ...
    xlim=c(0, 1.25),
    xlab="Proportion of Fragments",
    main="Proportion of \"On Target\" Fragments",
    ylab="",
    col=bar_cols)
...
### rRNA
This plot will show the proportion of bases that map to annotated rRNA features.

```{r rrna_map_plot, echo=FALSE, message=FALSE, fig.width=8, fig.height=0.4*nrow(sheet)}
par(mar=c(4, 3.5, 1, 0), mgp=c(2.5, 0.75, 0))
...
```{r subread_summary, echo=FALSE, message=FALSE, fig.width=8, fig.height=0.9*nrow(sheet)}
library(knitr)
par(mar=c(5.1, 5, 5.1, 0.1))
...
axis(side=1)
legend("top", categories, fill=bar_cols, ncol=2, xpd=TRUE)
```
...
legend("top", categories, fill=bar_cols, ncol=2)
