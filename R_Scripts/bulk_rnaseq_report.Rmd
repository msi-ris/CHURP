...
## Pipeline Script
The path to the pipeline script on MSI systerms is ``r params["pipeline"]``
...
xfun::embed_file(
    path=params["pipeline"],
    name=basename(params["pipeline"]),
...
cat("`echo ", basename(params["pipeline"]), "`\n")
```
...
xfun::embed_file(
    ...
    name=basename(params["samplesheet"]),
