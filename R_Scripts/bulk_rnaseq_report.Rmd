...
## Read Quality Plots
```{r raw_qual_sum, echo=FALSE, fig.width=8, fig.height=min(0.6*lg_cutoff, 2.4*nrow(sheet)), results='asis'}
...
```{r trim_qual_sum, echo=FALSE, fig.width=8, fig.height=min(0.6*lg_cutoff, 2.4*nrow(sheet)), results='asis'}
...
```{r epe_plot, echo=FALSE, message=FALSE, fig.width=8, fig.height=min(3.6*nrow(sheet), 0.4*lg_cutoff), results="asis"}
...
```{r dup_plot, echo=FALSE, message=FALSE, fig.width=8, fig.height=min(3.6*nrow(sheet), 0.4*lg_cutoff), results="asis"}
par(mar=c(4, 4, 5, 1), mgp=c(2.5, 0.75, 0))
...
```{r gdna_plot, echo=FALSE, message=FALSE, fig.width=8, fig.height=min(4.8*nrow(sheet), 0.6*lg_cutoff), results="asis"}
...
```{r rrna_map_plot, echo=FALSE, message=FALSE, fig.width=8, fig.height=min(3.6*nrow(sheet), 0.4*lg_cutoff), results="asis"}
par(mar=c(4, 4, 5, 1), mgp=c(2.5, 0.75, 0))
...
```{r raw_read_quals, echo=FALSE, message=FALSE, fig.width=8, fig.height=min(2.4*nrow(sheet), 0.6*lg_cutoff), results="asis"}
plotqual_first <- function(sn, draw_ax) {
    allquals <- matrix(0:45)
    image(
        allquals,
...
```{r trim_read_quals, echo=FALSE, message=FALSE, fig.width=8, fig.height=min(2.4*nrow(sheet), 0.6*lg_cutoff), results="asis"}
if(length(trim_samp) > 0) {
    plotqual_first <- function(sn, draw_ax) {
        allquals <- matrix(0:45)
        image(
...
```{r subread_summary, echo=FALSE, message=FALSE, fig.width=8, fig.height=min(4.8*nrow(sheet), 0.6*lg_cutoff), results="asis"}
library(knitr)
...
```{r subread_summary_prop, echo=FALSE, message=FALSE, fig.height=min(3.6*nrow(sheet), 0.4*lg_cutoff), results="asis"}
