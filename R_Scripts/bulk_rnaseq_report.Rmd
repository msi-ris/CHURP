...
# Alignment Summaries
## HISAT2 Statistics
The following plots summarize the mapping from HISAT2.

```{r hisat2_stats, echo=FALSE, message=FALSE}
...
rownames(count_dat) <- as.character(hisat_summary$SampleName)
barplot(
    t(count_dat),
    beside=FALSE,
...
rownames(prop_dat) <- as.character(hisat_summary$SampleName)
barplot(
    t(prop_dat),
    beside=FALSE,
    col=c("#1f78b4", "#a6cee3", "#b2df8a", "#999999"),
