...
```{r key_figs, echo=FALSE, message=FALSE, out.width="45%", out.height="350"}
library(knitr)
...
include_graphics(c(cpm_plot, heatmap_plot, mds_plot))
```
...
the inter-quartile range, and the vertical black lines show the 10th-90th
percentile range.
