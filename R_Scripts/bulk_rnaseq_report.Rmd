...
```{r epe_plot, echo=FALSE, message=FALSE, fig.width=8, fig.height=min(2, 0.4*lg_cutoff), results="asis"}
...
```{r dup_plot, echo=FALSE, message=FALSE, fig.width=8, fig.height=min(2, 0.4*lg_cutoff), results="asis"}
par(mar=c(4, 4, 5, 1), mgp=c(2.5, 0.75, 0))
...
```{r gdna_plot, echo=FALSE, message=FALSE, fig.width=8, fig.height=min(2.4, 0.6*lg_cutoff), results="asis"}
...
```{r rrna_map_plot, echo=FALSE, message=FALSE, fig.width=8, fig.height=min(2, 0.4*lg_cutoff), results="asis"}
par(mar=c(4, 4, 5, 1), mgp=c(2.5, 0.75, 0))
...
```{r subread_summary, echo=FALSE, message=FALSE, fig.width=8, fig.height=min(2.4, 0.6*lg_cutoff), results="asis"}
library(knitr)
...
```{r subread_summary_prop, echo=FALSE, message=FALSE, fig.height=min(2, 0.4*lg_cutoff), results="asis"}
