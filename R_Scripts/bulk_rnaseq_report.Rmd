...
(i.e., non-exon regions).

```{r gdna_plot, echo=FALSE, message=FALSE}
par(mfrow=c(2, 1), mar=c(4, 3.5, 1, 0), mgp=c(2.5, 0.75, 0))
cts_dat <- matrix(
    c(
...
```{r coverage_bias, echo=FALSE, message=FALSE, fig.width=8, fig.height=0.75*nrow(sheet)}
