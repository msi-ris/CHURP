...
rnaseqc_summary <- read.table(paste(params["workdir"], "allsamples", "RNASeq_Metrics.txt", sep="/"), header=F, sep="\t")
...
## Read Quality Plots
```{r raw_qual_sum, echo=FALSE, fig.width=8, fig.height=0.8*24, results='asis'}
...
### Trimmed Reads
```{r trim_qual_sum, echo=FALSE, fig.width=8, fig.height=0.8*24, results='asis'}
